    ...
    internal class Program
    {
        ...
        */
        public static void AddUpdateEntityInDisconnectedScenario()
        {
            ...
            //inside context or outside context
        ...
        */
        public static void LinqToEntitiesQueries()
        {
            ...
            {
                // For testing
                string[] studentNames = new string[] { "Michael", "Scott", "Scott", "Mary", "Joe", "Joe"};
                AddStudents(studentNames);

                //Log DB commands to console
                //context.Database.Log = Console.WriteLine;

                //Retrieve students whose name is Jini - Linq-to-Entities Query Syntax
                ...
                var standard1Students = context.Students.Where(s => s.StandardId == 1).ToList();
        ...
        */
        public static void FindEntity()
        {
            ...
            using (var context = new SchoolDBEntities())
            {
                ...
                var stud = context.Students.Find(21);
                if (stud != null)
